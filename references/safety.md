...
2. **Requests:** use minimum public inputs and public endpoints. Do not request credentials, create accounts or activate billing. Keep private context, keys and wallet sessions out of URLs, headers, RPC arguments, redirects and delegated requests.
