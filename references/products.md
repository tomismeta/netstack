...
The displayed trailing four-week annualized rate derives from weekly share-price returns; no settled week existed at launch. It is backward-looking, not a promised yield or compounded one-year forecast. Contract, valuation, resolver, concentrated outcome/skew, USDG and withdrawal-timing risks remain. The app calls Predict **“a bet, not a hedge” (18+)**. Read-only research does not connect an account, trade, guess, deposit or withdraw.
